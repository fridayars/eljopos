      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[80vh] z-50"
          >
            <div className="bg-[#0F0F14] backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-[0_0_50px_rgba(59,130,246,0.3)] overflow-hidden flex flex-col max-h-[80vh]">
              ...
              <div className="relative p-6 border-b border-purple-500/20">
                ...
                <div className="relative flex items-center justify-between">
                  <h2 className="text-xl text-gray-200">Select Customer</h2>
                  <button
                    onClick={onClose}
                  ...
                  <div className="space-y-2">
                    {filteredCustomers.map((customer) => (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        className="w-full p-4 bg-white/5 hover:bg-white/10 border border-purple-500/20 hover:border-blue-500/50 rounded-xl transition-all text-left group"
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <div className="ml-4 px-3 py-1 bg-blue-500/10 border border-blue-500/30 rounded-lg text-xs text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity">
                            Select
                          </div>
                        </div>
                      </motion.button>
