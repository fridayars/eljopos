...
import { Coffee, Croissant, Sandwich, IceCream, Salad, UtensilsCrossed } from 'lucide-react';

export type CategoryType = 'all' | 'beverages' | 'pastries' | 'meals' | 'desserts' | 'healthy';
...
const categories: Category[] = [
  ...
  { id: 'meals', label: 'Meals', icon: Sandwich },
