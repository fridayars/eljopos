  ...
  return (
    ...
    >
      {products.map((product) => (
        ...
        >
          {/* Product Image */}
          <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-blue-500/10 to-purple-600/10">
            <img
              src={product.image}
              alt={product.name}
            ...
            <div className="absolute top-2 md:top-3 right-2 md:right-3 px-2 md:px-3 py-1 bg-black/60 backdrop-blur-sm rounded-lg border border-cyan-400/30">
              <span className="text-xs md:text-sm text-cyan-400">{product.stock} left</span>
            </div>
          </div>
          ...
          <div className="p-3 md:p-4 space-y-2 md:space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="text-lg md:text-xl bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
