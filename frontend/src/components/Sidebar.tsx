...
export function Sidebar({ activeTab, onTabChange }: SidebarProps) {
    return (
        <>
            {/* Desktop Sidebar */}
            <aside
                className="hidden lg:flex w-20 flex-col items-center py-6 gap-4 shrink-0"
                style={{
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className="relative w-full h-14 rounded-xl flex flex-col items-center justify-center gap-1 transition-all duration-200 cursor-pointer"
                                style={{
                            ...
                            >
                                ...
                                <span className="text-[9px] relative z-10 font-medium tracking-wide">
