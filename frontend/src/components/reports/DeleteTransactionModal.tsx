                ...
                >
                    ...
                    <div className="relative overflow-hidden">
                        ...
                        <div className="relative flex flex-col items-center pt-8 pb-4 px-6">
                            ...
                            <h3 className="text-xl text-gray-100 font-semibold mb-1">Hapus Transaksi?</h3>
                            <p className="text-sm text-gray-400 text-center">
                                Tindakan ini mengembalikan stok produk tetapi tidak dapat dibatalkan
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="px-6 pb-4">
                        <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4">
                            <p className="text-sm text-gray-300 text-center leading-relaxed">
                                Anda akan menghapus transaksi dengan invoice <br />
                                <span className="text-red-400 font-bold inline-block mt-1 px-2 py-0.5 bg-red-500/20 rounded grow">{invoiceNumber}</span>. <br />
                                Transaksi yang dihapus tidak akan muncul di laporan.
                            </p>
                        </div>
                    </div>
                    ...
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-gray-500 hover:text-gray-300 transition-all cursor-pointer"
                    >
                        <X className="w-4 h-4" />
                    </button>
                </motion.div>
