            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] md:w-full md:max-w-md max-h-[90vh] z-50 flex flex-col"
                    >
                        <div className="bg-[#0F0F14] backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-[0_0_50px_rgba(59,130,246,0.3)] overflow-hidden flex flex-col h-full">
                            ...
                            <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-5">
                                ...
                                {change > 0 && (
                                    ...
                                    >
                                        <p className="text-xs md:text-sm text-gray-400 mb-2">Kembalian</p>
                                        <div className="text-xl md:text-2xl text-green-400 font-bold">
                            ...
                            <div className="p-4 md:p-6 border-t border-purple-500/20 flex gap-3 shrink-0">
                                ...
                                <button
                                    ...
                                    className="flex-1 h-11 md:h-12 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base font-semibold cursor-pointer"
                                >
                                    Konfirmasi
                                </button>
                            </div>
