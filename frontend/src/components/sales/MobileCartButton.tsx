...
export function MobileCartButton({ itemCount, onClick }: MobileCartButtonProps) {
    return (
        <button
            onClick={onClick}
            className="xl:hidden fixed bottom-20 right-4 md:bottom-24 md:right-6 w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-[0_0_30px_rgba(59,130,246,0.5)] flex items-center justify-center z-30 cursor-pointer"
        >
